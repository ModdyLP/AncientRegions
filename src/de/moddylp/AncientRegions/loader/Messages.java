...
public class Messages {
    ...
    private void setup() {
        ...
        lang.setTextOnce("WeatherInfo", "Please type a form of Weather! Valid Values are 'sun, clear, storm, thunder, rain and downfall'!");
        lang.setTextOnce("Gamemode", "Please type a form of Gamemode! Valid Values are 'creative, survival, adventure, spectator, 0,1,2,3'!");
        ...
        lang.setTextOnce("Selling", "The region was selled, this will take a while");
        ...
        lang.setTextOnce("InvalidWeather", "Invalid Format! Use 'sun', 'clear', 'thunder', 'storm' or 'rain'! Try again!");
        lang.setTextOnce("InvalidGamemode", "Invalid Format! Use 'survival', 'creative', 'spectator', 'adventure'! Try again!");
        lang.setTextOnce("CommandNotFound", "This parameter doesn't exist, please choose another. Type /ancr help for help!");
        lang.setTextOnce("ConfigError", "There is an error in the Config. Please contact your Adminstrator. Error by: [PH]");
