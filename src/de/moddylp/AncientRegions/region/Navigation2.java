...
public class Navigation2 {
    public boolean loadguiitems(Inventory menu, Main plugin) {
        ...
        Mainmenu2.setItemMeta((ItemMeta)pmeta3);
        ItemMeta imeta3 = Mainmenu2.getItemMeta();
        imeta3.setDisplayName(ChatColor.RED + plugin.lang.getText("Back"));
        imeta3.addItemFlags(new ItemFlag[]{ItemFlag.HIDE_ATTRIBUTES});
        imeta3.addItemFlags(new ItemFlag[]{ItemFlag.HIDE_POTION_EFFECTS});
        Mainmenu2.setItemMeta(imeta3);
        menu.setItem(45, Mainmenu2);
        return true;
    }
}
