...
import de.moddylp.AncientRegions.gui.Events.TimeFormat;
					...
					if (rg.getFlag(flag) != null) {
						...
						if (payment(p, e)) {
							...
							plugin.getServer().getPluginManager()
									.registerEvents(new TimeFormat(p, rg, flag, flagname, plugin, worldguard), plugin);
							p.sendMessage(ChatColor.GREEN + "[AR][INFO] "
									+ plugin.lang.getText("Message5").replace("[PH]", flagname));
						}
					}
				} else {
