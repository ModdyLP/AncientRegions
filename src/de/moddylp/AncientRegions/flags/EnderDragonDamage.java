...
public class EnderDragonDamage {
	//Flag Description
	StateFlag flag = DefaultFlag.ENDERDRAGON_BLOCK_DAMAGE;
	String flagname = "EnderDragonDamage";
	String permission = "toggle"+flagname.toLowerCase();
	private Main plugin;
	
	
	public EnderDragonDamage(Main plugin){
		this.plugin = plugin;
	}
