...
public class FeedMaxHunger {
	//Flag Description
	IntegerFlag flag = DefaultFlag.MAX_FOOD;
	String flagname = "FeedMaxHunger";
	String permission = flagname.toLowerCase();
	private Main plugin;
	private WorldGuardPlugin worldguard;
	private Player p;
	private ProtectedRegion rg;
	public FeedMaxHunger(Main plugin, WorldGuardPlugin worldguard, Player p){
		this.plugin = plugin;
