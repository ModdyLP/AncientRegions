...
public class HealDelay {
	//Flag Description
	IntegerFlag flag = DefaultFlag.HEAL_DELAY;
	String flagname = "HealDelay";
	String permission = flagname.toLowerCase();
	private Main plugin;
	private WorldGuardPlugin worldguard;
	private Player p;
	private ProtectedRegion rg;
	public HealDelay(Main plugin, WorldGuardPlugin worldguard, Player p){
		this.plugin = plugin;
