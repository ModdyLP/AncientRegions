...
public class EntityPaintingDestroy {
	//Flag Description
	private Main plugin;
	StateFlag flag = DefaultFlag.ENTITY_PAINTING_DESTROY;
	String flagname = "EntityPaintingDestroy";
	String permission = "toggle"+flagname.toLowerCase();

	
	
	public EntityPaintingDestroy(Main plugin){
		this.plugin = plugin;
	}
